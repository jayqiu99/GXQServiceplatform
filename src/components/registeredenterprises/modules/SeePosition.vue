<template>
  ...
  >
    ...
    <div class="drawer-bootom-button" v-show="!disableSubmit">
      ...
      <a-button @click="Selectlocation()" type="primary">确认信息并下一页</a-button>
      <!-- <a-button style="margin-right: .8rem" @click="handleCancel">取消</a-button> -->
      <!-- </a-popconfirm> -->
    </div>
    <determine ref="determineinfo" @ok="modalFormOktwo"></determine>
    ...
    >
      ...
      <div class="drawer-bootom-button">
        <a-button style="margin-right: 0.8rem" @click="zwtouplist()">上一页</a-button>
        <a-button @click="zwnext()" type="primary">确认信息并下一页</a-button>
        <!-- <a-button type="primary" style="margin-left: 95%;margin-top: 1%" @click="xzhandleCancel">关闭</a-button> -->
...
import BoothPage from './NewBooth'
...
export default {
  ...
  methods: {
    zwnext() {
      console.log('下一页3333', this.enterpriseinfoobj)
    ...
    Selectlocation() {
      this.visible = false
      console.log('下一页2', this.enterpriseinfoobj)
      this.recordData = this.enterpriseinfoobj
    ...
    Selectlocationtwo(res) {
      this.visible = false
      console.log('返回页面', res)
      this.recordData = res
      this.boothkey = !this.boothkey
      this.zwvisible = true
      // this.$refs.modalFormlist.reset()
    ...
    modalFormOktwo(rest) {
      console.log('父组件2', rest)
      this.Selectlocationtwo(rest)
    },
    modalFormOk(rest) {
    ...
    handleTableChange(e) {
      ...
      if (this.ipagination.pageSize != e.pageSize) {
        this.ipagination.current = 1
        queryParam.pageNo = 1
      } else {
        this.ipagination.current = e.current
        queryParam.pageNo = e.current
      }
      this.ipagination.pageSize = e.pageSize
      queryParam.pageSize = e.pageSize
    ...
    loadData(queryParam) {
      ...
      // queryParam.pageSize = this.ipagination.pageSize //查询条件
      console.log('审核查询条件')
