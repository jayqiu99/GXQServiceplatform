...
<a-drawer
  ...
  > -->
    ...
    <div v-show="showRentPrise" style="padding-top: 10%">
      <a-divider orientation="left"> 不通过原因 </a-divider>
      <a-textarea v-model="stateremarks" :disabled='disothertext' placeholder="审核不通过原因......." style="height:300px" :auto-size="{ minRows: 3, maxRows: 20 }" />
    </div>
...
import { invitationjobfair, getenterpriseList, staffList, poststaff, getaddticket, getcancelticket,getOnekey,editexamine } from '@/api/api'
