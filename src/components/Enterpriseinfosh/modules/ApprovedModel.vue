        ...
        <a-row :gutter="12">
          <a-col :span="23" :pull="3">
            <a-form-item label="企业简介" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea
                maxlength="300"
                placeholder="请输入企业简介（最多只能输入300字）"
                v-decorator.trim="['synopsis', validatorRules.synopsis]"
        ...
        <a-row :gutter="12">
          <a-col :span="9">
            <a-form-item label="联系人" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input
                placeholder="请输入联系人"
                v-decorator.trim="['companyPrincipal', validatorRules.companyPrincipal]"
              />
            </a-form-item>
          </a-col>
          <a-col :span="9">
        ...
        <a-row :gutter="12">
          ...
          <a-col :span="9">
            <a-form-item label="企业性质" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-select
                show-search
                v-decorator.trim="['nature']"
                option-filter-prop="children"
                :filter-option="filterOption"
              >
                <a-select-option value>请选择</a-select-option>
                <a-select-option
                  v-for="d in natureoption"
                  :key="d.id"
                  :value="d.dataName"
          ...
          <a-col :span="9">
            ...
            <a-form-item label :labelCol="labelCol" :wrapperCol="wrapperCol">
              <h5 style="margin-left: 15%; width: 100%">
                注：图片格式为png，不能超过1M
                <span style="color: red">，请上传带公章的营业执照</span>
              </h5>
            </a-form-item>
            <div style="margin-top: -31%; margin-right: 32.8%; float: right">
              <a-button
                type="primary"
                shape="circle"
                icon="search"
                @click="handlePreview(businessList)"
              />
            </div>
          </a-col>
        </a-row>
          ...
          <a-col :span="9">
            <a-form-item label="委托书" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <u-image-upload
                class="avatar-uploader"
                text="上传"
                @eChange="wtsimgChange"
                v-model="wtsimglist.url"
              ></u-image-upload>
            </a-form-item>
            ...
            <div style="margin-top: -31%; margin-right: 33%; float: right">
              <a-button
                ...
                shape="circle"
                icon="search"
                @click="handlePreview(wtsimglist)"
              />
            </div>
          </a-col>
          <a-col :span="9">
            <a-form-item label="用工备案表" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <u-image-upload
                class="avatar-uploader"
                text="上传"
                @eChange="babimgChange"
                v-model="babimglist.url"
              ></u-image-upload>
            </a-form-item>
            ...
            <div style="margin-top: -31%; margin-right: 33%; float: right">
              <a-button
                ...
                shape="circle"
                icon="search"
                @click="handlePreview(babimglist)"
              />
            </div>
          </a-col>
        </a-row>
...
import VideoUp from '../../../components/jeecg/FileexceUp.vue'
  ...
  methods: {
    ...
    edit(record) {
      ...
      setTimeout(() => {
        ...
        this.logoimgstr = record.logoAddress
        console.log('图0', this.logoAddress)
        console.log('图1', this.fileList)
        console.log('图2', this.businessList)
            ...
            if (this.exaupdata.examinestate == 0) {
              ...
              if (!this.model.id) {
                ...
                if (this.logoistrue == false) {
                  ...
                  console.log('进来true', formData.logoAddress)
                }
