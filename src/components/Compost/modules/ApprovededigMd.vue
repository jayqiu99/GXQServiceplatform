  ...
  <a-drawer :title="title" :maskClosable="true" :width="drawerWidth" placement="right" :closable="true"
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-row :gutter="12">
          <a-col :span="23" :pull="3">
            <a-form-item label="企业名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input placeholder="请输入企业名称" disabled="true"
        ...
        <a-row :gutter="12">
          <a-col :span="23" :pull="3">
            <a-form-item label="企业简介" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea placeholder="请输入企业简介" disabled="true" v-decorator.trim="['synopsis']"
                :auto-size="{ minRows: 2, maxRows: 6 }" style="color: black;" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="12">
          <a-col :span="9">
            <a-form-item label="联系人" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input placeholder="请输入联系人" disabled="true" v-decorator.trim="['companyPrincipal']" />
            </a-form-item>
          </a-col>
          <a-col :span="9">
            <a-form-item label="联系电话" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input placeholder="请输入联系电话" disabled="true" v-decorator="['phone', validatorRules.phone]" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="12">
          <a-col :span="9">
            <a-form-item label="企业信用代码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input placeholder="请输入企业信用代码" v-decorator.trim="['creditCode']" disabled="true" />
            </a-form-item>
          </a-col>
          <a-col :span="9">
            <a-form-item label="企业性质" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-select show-search style="color: black;" v-decorator.trim="['nature']" option-filter-prop="children"
                :filter-option="filterOption" disabled="true">
        ...
        <a-row :gutter="12">
          <a-col :span="9">
            <a-form-item label="所属行业" :labelCol="labelCol" :wrapperCol="wrapperCol">
              ...
              <a-select show-search style="color: black;" disabled="true"
                v-decorator.trim="['trade', validatorRules.trade]" option-filter-prop="children"
          ...
          <a-col :span="9">
            <a-form-item label="企业规模" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-select show-search disabled="true" style="color: black;" v-decorator.trim="['scale']"
        ...
        <a-row :gutter="12">
          <a-col :span="9">
            <a-form-item label="工作区域" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-select show-search disabled="true" style="color: black;" v-decorator.trim="['area']"
                option-filter-prop="children" :filter-option="filterOption">
                <a-select-option value>请选择</a-select-option>
          ...
          <a-col :span="9">
            <a-form-item label="所在地址" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input placeholder="请输入所在地址" disabled="true" v-decorator.trim="['address']" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="12">
          <a-col :span="23" :pull="3">
            <a-form-item label="邮箱" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input placeholder="请输入邮箱" disabled="true" v-decorator.trim="['email']" />
            </a-form-item>
          </a-col>
        </a-row>
        <!-- <a-form-item label="联系人身份证" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入联系人身份证" disabled="true" v-decorator.trim="['idcard']" />
        </a-form-item> -->
        ...
        <a-row :gutter="12">
          <a-col :span="9">
            <a-form-item label="企业logo" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-image-upload class="avatar-uploader" @eChange="eChange" disabled="true" text="上传"
                v-model="fileList.url"></j-image-upload>
            ...
            <div style="margin-top: -31%; margin-right: 32%; float: right">
              <a-button type="primary" shape="circle" icon="search" @click="handlePreview(fileList)" />
            </div>
          </a-col>
          <a-col :span="9">
            <a-form-item label="营业执照111" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <u-image-upload class="avatar-uploader" disabled="true" text="上传" @eChange="eimgChange"
                v-model="businessList.url"></u-image-upload>
            </a-form-item>
            <a-form-item label :labelCol="labelCol" :wrapperCol="wrapperCol">
              <h5 style="margin-left: 15%">注：图片格式为png，不能超过1M</h5>
            </a-form-item>
        ...
        <a-row :gutter="12">
          <a-col :span="9">
            <a-form-item label="委托书" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <u-image-upload class="avatar-uploader" disabled="true" text="上传" @eChange="wtsimgChange"
                v-model="wtsimglist.url"></u-image-upload>
            </a-form-item>
            <a-form-item label :labelCol="labelCol" :wrapperCol="wrapperCol">
              <h5 style="margin-left: 15%">注：图片格式为png，不能超过1M</h5>
            </a-form-item>
          ...
          <a-col :span="9">
            <a-form-item label="备案表" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <u-image-upload class="avatar-uploader" disabled="true" text="上传" @eChange="babimgChange"
                v-model="babimglist.url"></u-image-upload>
            </a-form-item>
            <a-form-item label :labelCol="labelCol" :wrapperCol="wrapperCol">
              <h5 style="margin-left: 15%">注：图片格式为png，不能超过1M</h5>
            </a-form-item>
        ...
        <!-- <a-form-item label="上传多媒体" :labelCol="labelCol" :wrapperCol="wrapperCol"> -->
        ...
        <a-form-item label="图片" :labelCol="labelCol" :wrapperCol="wrapperCol">
          ...
          <div class="clearfix">
            <a-upload
              ...
              :file-list="enterfileList"
              @preview="enterhandlePreview"
              @change="enterleChange"
            >
              <div v-if="enterfileList.length < 8">
                <a-icon type="plus" />
                <div class="ant-upload-text">Upload</div>
              </div>
            </a-upload>
            <a-modal :visible="enterimageVisible" :footer="null" @cancel="enterleCancel">
              <img alt="example" style="width: 100%" :src="enterpreviewimage" />
            </a-modal>
          </div>
        </a-form-item>
      </a-form> -->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async enterhandlePreview(file) {
        if (!file.url && !file.preview) {
          file.preview = await getBase64(file.originFileObj)
        }
        console.log('图片浏览阿', file.url)
        console.log('图片浏览阿2', file.preview)
        this.enterpreviewimage = file.url || file.preview
        this.enterimageVisible = true
      },
      enterleChange({ enterfileList }) {
      ...
      radioChange(radiores) {
        ...
        if (radiores.target.value == 2) {
          that.visible = false
          this.$refs.mulitFormOk.ttedit(this.exaupdata)
        }
      ...
      async handlePreview(file) {
        console.log('委托书', file)
        if (!file.url && !file.preview) {
          console.log('图片浏览', file)
          file.preview = await getBase64(file.originFileObj)
        }
      ...
      edit(record) {
        ...
        console.log('轮播修改对象：', this.enterfileList)
        this.edradio = 1
        ...
        setTimeout(() => {
          ...
          this.imgstrurl = this.imgstrurl.slice(44)

          console.log('截取后路径', this.imgstrurl)
          this.byidimg = record.logoAddress
          this.byidimg = this.byidimg.slice(37)
          ...
          this.fileList.thumbUrl = record.logoAddress
          this.businessList.url = httpurla + record.businessLicenseAddress
          // this.wts = httpurla + record.poweraTtorneyAddress
          // this.bab = httpurla + record.employmentFilingAddress
            ...
            if (!this.model.id) {
              ...
              if (this.exaupdata.examinestate == 0) {
                ...
                if (!this.model.id) {
                  ...
                  formData.businessLicenseAddress = this.updataimgstrurl
                  formData.updateBy = store.getters.userInfo.username
                  // console.log("修改数据对象图片1",this.upimgstrurl);
                  // console.log("修改数据对象图片2",this.updataimgstrurl);
                  if (this.upimgstrurl == '' || this.upimgstrurl == undefined) {
                    // console.log("修改数据对象图片3",this.byidimg);
                    formData.logoAddress = this.byidimg
                  }
      ...
      // 获取用户对应部门弹出框提交给返回的数据
      modalFormOk(formDat, byid) {
        console.log('上一页传值', formDat)
