            ...
            <detail-list>
              ...
              <detail-list-item v-if="boothtext.effectiveState == 3" term="是否长期有效" style="width: 100%; margin-top: 2%">
                <a-range-picker :show-time="{ format: 'HH:mm' }"
                  ...
                  style="width: 100%" :placeholder="['举办开始时间', '举办结束时间']"
                  :value="[this.moment(boothtext.effectiveStartdate, dateFormat),this.moment(boothtext.effectiveEnddate, dateFormat)]"
                  @change="dateonChange" />
                <a-range-picker
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      return {
        isageteue: false,
        postchangeistrue:false,
        areachangeistrue:false,
        issalary: false,//薪资
        tsfwoptions: [],
        areassq: [],
        areaoption: [], //区域
    ...
    methods: {
      ...
      isAblefalse(rowrecord) {
        // this.postchangeistrue=false;
        // this.areachangeistrue=false;
        this.bba = []
        this.ispd = 0
        this.addis = 0
        ...
        return {
          on: {
            click: () => {
              ...
              this.boothtext.bdmAreaInfoId=trecord.bdmAreaInfoId;
              this.boothtext.jobTypeId=trecord.jobTypeId;
              this.boothtext.areaname
