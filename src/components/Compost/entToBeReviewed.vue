    ...
    <a-card :bordered="false">
      ...
      <div class="table-page-search-wrapper">
        <div style="margin-left: 5%">
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="12">
              ...
              <a-col :md="7" :sm="8">
                <a-form-item label="岗位名称" :labelCol="{ span: 6 }" :wrapperCol="{ span: 14, offset: 1 }">
                  <a-input placeholder="请输入岗位名称" v-model="queryParam.postName"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="9" :sm="8" style="margin-left: 5.89%">
        ...
        <div class="table-operator" style="border-top: 5px">
          ...
          <a-button @click="batchExamine" type="primary"><a-icon type="check" /> 批量提交审核</a-button>
          <!-- <a-upload name="file" style="margin-left: 1px;display:inline-block" :multiple="false" @change="changeFile"
            accept=".excle, .xlsx" :customRequest="customRequest">
            <a-button type="primary">
              <a-icon type="upload" />导入Excel
            </a-button>
          </a-upload> -->
          <a-button type="primary" style="margin-left: 3px; display: inline-block" @click="exportFile"
            >导出查询数据</a-button
          >
          <!-- <a-dropdown v-if="selectedRowKeys.length > 0">
            <a-menu slot="overlay" @click="handleMenuClick">
              ...
              <a-menu-item key="2"> <a-icon type="check" @click="batchExamine" />批量提交审核 </a-menu-item>
            </a-menu>
...
import UserModal from './modules/entApprovedModel'
          ...
          enTemporaryList3(params).then((res) => {
            ...
            if (params.enterpriseid == '' || params.enterpriseid == null) {
              ...
              if (res.success) {
                ...
                console.log('待审核列表', res.result.records)
