  ...
  <div class="main">
    ...
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
      ...
      <a-form-item>
        ...
        <router-link v-show="true" :to="{ name: 'alteration'}" class="forge-password" style="float: right;">
          忘记密码
        </router-link>
        <router-link v-show="true" :to="{ name: 'register'}" class="forge-password" style="float: right;margin-right: 10px">
          企业注册
        </router-link>
      </a-form-item>
...
<style>
  ...
  #username:focus, #password:focus, #inputCode:focus{
    border-color: #ffc53d;
    box-shadow: none;
  }
</style>