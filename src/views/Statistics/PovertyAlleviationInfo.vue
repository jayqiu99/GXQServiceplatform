        ...
        <a-row :gutter="12">
          <a-col :md="7" :sm="8" :push="2">
            <a-form-item label="姓名" :labelCol="{ span: 6 }" :wrapperCol="{ span: 14, offset: 1 }">
              <a-input placeholder v-model="queryParam.test1"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="7" :sm="8" :push="3">
            <a-form-item label="身份证号码" :labelCol="{ span: 6 }" :wrapperCol="{ span: 14, offset: 1 }">
              <a-input placeholder v-model="queryParam.test2"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="12">
          <a-col :md="7" :sm="8" :push="2">
            <a-form-item label="性别" :labelCol="{ span: 6 }" :wrapperCol="{ span: 14, offset: 1 }">
              <a-select v-model="queryParam.test3" placeholder="请选择性别">
          ...
          <a-col :md="7" :sm="8" :push="3">
            <a-form-item label="帮 扶 类 型" :labelCol="{ span: 6 }" :wrapperCol="{ span: 14, offset: 1 }">
              <a-select v-model="queryParam.test4" placeholder="请选择帮扶类型">
                <a-select-option value>请选择</a-select-option>
                <a-select-option value="1">4050类型</a-select-option>
                <a-select-option value="2">残障人员</a-select-option>
                <a-select-option value="3">低保人员</a-select-option>
                <a-select-option value="4">长期失业</a-select-option>
                <a-select-option value="5">零就业家庭</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col :md="7" :sm="8" :push="3">
