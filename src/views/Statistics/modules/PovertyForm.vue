    ...
    <j-form-container :disabled="formDisabled">
      <a-form :form="form" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="帮扶金额" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input
                v-decorator="['name1', { rules: [{ required: true, message: '请输入帮扶金额' }] }]"
                placeholder="请输入帮扶金额"
              ></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="7" :sm="8" :push="2">
           ...
           <a-col :md="7" :sm="8" :push="2" style="margin:10% 0 0 -29% ;">
            <a-form-item  label="帮扶类型" :labelCol="{ span: 10}" :wrapperCol="{ span: 70, offset: 10 }">
              <a-select v-model="test" style='width:393%' placeholder="请选择帮扶类型">
                <a-select-option value>请选择</a-select-option>
