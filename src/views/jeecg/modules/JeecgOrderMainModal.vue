      ...
      <a-form :form="form">
        ...
        <a-tabs defaultActiveKey="1" >
          <a-tab-pane tab="客户信息" key="1">
            <div>
              <a-row type="flex" style="margin-bottom:10px" :gutter="16">
                <a-col :span="9">客户名</a-col>
                <a-col :span="9">性别</a-col>
                <a-col :span="9">身份证号码</a-col>
                <a-col :span="9">手机号</a-col>
          ...
          <a-tab-pane tab="机票信息" key="2" forceRender>
            <div>
              <a-row type="flex" style="margin-bottom:10px" :gutter="16">
                <a-col :span="9">航班号</a-col>
                <a-col :span="9">航班时间</a-col>
                <a-col :span="9">操作</a-col>
              </a-row>
