    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          <a-button @click="handleAdd(1)" type="primary">添加公司</a-button>
      ...
      <a-tabs defaultActiveKey="1">
        <a-tab-pane tab="基本信息" key="1">
          <a-card :bordered="false" v-if="selectedKeys.length>0">
            <a-form :form="form">
              <a-form-item v-if="isture" :labelCol="labelCol" :wrapperCol="wrapperCol" label="机构名称">
                <a-input
                  placeholder="请输入企业/部门名称"
...
export default {
  ...
  methods: {
    ...
    handleChange(value, res) {
      ...
      console.log("企业名称12",this.currSelected);
      this.currSelected.departName=res.componentOptions.children[0].text;
      // this.currSelected
      // this.qyId = value
    ...
    setValuesToForm(record) {
      ...
      this.$nextTick(() => {
        ...
        this.form.setFieldsValue(
          pick(record, 'departName','enterpriseInfoId', 'orgCategory', 'orgCode', 'departOrder', 'mobile', 'fax', 'address', 'memo')
        )
      })
    },
    ...
    handleAdd(num) {
      if (num == 1) {
        ...
        this.$refs.departModal.add(this.selectedKeys, 2)
        this.$refs.departModal.title = '新增'
      } else {
