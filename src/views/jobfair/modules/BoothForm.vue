        ...
        <a-row>
          ...
          <a-col :span="23" :pull="3">
            <a-form-item label="费用明细" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea placeholder="请输入费用明细"  v-decorator="['feeDetails', { rules: [{ required: true, message: '请输入费用明细' }] }]"
            :auto-size="{ minRows: 2, maxRows: 6 }" />
            </a-form-item>
          </a-col>
          <a-col :span="23" :pull="3">
            <a-form-item label="报名要求" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea placeholder="请输入报名要求"  v-decorator="['requirement', { rules: [{ required: true, message: '请输入报名要求' }] }]"
            :auto-size="{ minRows: 2, maxRows: 6 }" />
