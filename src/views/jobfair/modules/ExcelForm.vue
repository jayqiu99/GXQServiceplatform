    ...
    <j-form-container :disabled="formDisabled">
      <a-form :form="form" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="薪酬" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input
                v-decorator="['theme', { rules: [{ required: true, message: '请输入招聘会主题' }] }]"
                placeholder="请输入薪酬"
              ></a-input>
          ...
          <a-col :span="24">
            <a-form-item label="区域" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input
                v-decorator="['theme', { rules: [{ required: true, message: '请输入区域' }] }]"
                placeholder="请输入区域"
              ></a-input>
          ...
          <a-col :span="24">
            <a-form-item label="详细地址" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input
                v-decorator="['theme', { rules: [{ required: true, message: '请输入详细地址' }] }]"
                placeholder="请输入详细地址"
              ></a-input>
