<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper" id="tableinfo">
        ...
        <a-row :gutter="12">
          <a-col :md="7" :sm="8" :push="2">
            <a-form-item label="学历" :labelCol="{span: 6}" :wrapperCol="{span: 14, offset: 1}">
              <a-input placeholder v-model="queryParam.education"></a-input>
            </a-form-item>
          </a-col>
     ...
     <education-modal ref="modalForm" @ok="modalFormOk"></education-modal>
  </a-card>
</template>
...
import EducationModal from '../basicinfo/modules/EducationModal'
import Vue from 'vue'

export default {
  name: 'MajorType',
  mixins: [JeecgListMixin],
  components: { EducationModal },
  data() {
    return {
      // 查询条件
      queryParam: {
