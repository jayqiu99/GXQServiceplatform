  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" style="margin-left:10%" @keyup.enter.native="searchQuery">
        <a-row :gutter="12">
          <a-col :md="7" :sm="8">
            <a-form-item label="企业规模" :labelCol="{span: 7}" :wrapperCol="{span: 16, offset: 1}">
              <a-input placeholder="请输入企业规模" v-model="queryParam.name"></a-input>
            </a-form-item>
          </a-col>
          <!-- <a-col :md="7" :sm="8">
...
for (let i = 0; i < 46; i++) {
  ...
  import { scaleList } from '@/api/api'
  import { filterObj } from '@/utils/util';
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import DictModal from '../basicinfo/modules/ScaleModal'
